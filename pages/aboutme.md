...
- The majority of my self-taught years have been spent developing audio plug-ins for DAWs in C++ using the JUCE framework. This stems from my background in music and my growing curiosity about audio technology.
    ...
    - Worked on UI/UX and audio DSP components.

    - Developed fully functional audio plug-ins, including a drum sample library, a graphic EQ, audio effects, and custom user interfaces.

        - Since many of these projects were created early in my learning journey, they aren't currently posted in my Projects section. As explained under [what I'm doing now](#doing), I'm redeveloping many of them and will publish them once they're complete.

        - The drum sample library plug-in was my most ambitious project and remains the one I'm most proud of. It's a virtual drummer that reads MIDI notes and plays the corresponding audio files. More on this project under [what I'm most proud of](#what-im-most-proud-of).
...
- Began focusing more heavily on Java and Python in 2023 when I started my undergraduate studies in Computer Science at Colorado State University. During my studies, I also gained experience with RESTful APIs, integration and unit testing, distributed systems, operating systems, and computer architecture.
...
- Building a personal C++ static library to streamline audio plug-in development with the JUCE framework. At the moment, it consists primarily of custom GUI components such as buttons, sliders, and audio mixer components (fader, pan, channel), but the plan is to also include DSP modules as well as more complex GUI components such as equalizers.
    ...
    - I plan to use this library to redevelop many of my early projects as previously explained under [What I've done](#done), including the drum sample library plug-in.
...
- I independently developed a fully functional drum sample library plug-in for Digital Audio Workstations (DAWs) designed to compete in the professional audio production market. It's a virtual drummer that reads MIDI notes and plays the corresponding audio files.
    ...
    - I developed an approach for combining the drum sample recording process with the plug-in's playback engine to produce the most human-sounding performance possible. Since cymbals were often the least convincing part of drum sample libraries, I also designed a solution to address that challenge.
